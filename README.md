...
19 plugins. 75 skills. 69 hooks. 4 agents. 13 behavioral rules.
...
| [**forge-meta**](plugins/forge-meta/README.md) | Self-evolution boundary: change-manifest writer, evolution-history ledger, session-digest, auto-tune-skill outer loop, manifest-analyze reporter, controllability invariant (POLICY.md) | 3 | 5 |
