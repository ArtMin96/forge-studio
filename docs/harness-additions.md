...
| 5 | Harness metrics scorecard | `plugins/forge-meta/skills/harness-metrics/SKILL.md`, `plugins/forge-meta/skills/harness-metrics/scripts/score.sh` | `/harness-metrics` — 7-row Markdown table + JSON written to `.claude/metrics/<date>.json` |
