...
Behavioral steering through hooks. Fourteen principle-based rules injected into every turn, plus mechanical guards against destructive commands and out-of-scope edits.
