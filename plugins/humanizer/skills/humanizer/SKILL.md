...
when_to_use: "Reach for this when a draft, message, email, comment, or doc reads like AI wrote it and you want it to sound human. Paste the text or run /humanizer on it, optionally with a sample of your own writing for voice matching. Do NOT use to compress prose for token savings; use /caveman instead, since humanizer rewrites toward natural human prose while caveman strips prose down."
license: MIT
argument-hint: <text to humanize | file path>
...
allowed-tools:
  ...
  - Glob
  - AskUserQuestion
logical: "input text rewritten to remove AI tells; final rewrite contains no em or en dashes"
---
