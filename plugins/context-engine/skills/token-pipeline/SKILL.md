...
when_to_use: Fires automatically via track-context-pressure at ~65% pressure; invoke manually any time context feels heavy or auto-compact looks imminent. Do NOT use for a holistic context audit before work starts — use `/audit-context` instead; this skill is the in-flight pressure-relief decision.
