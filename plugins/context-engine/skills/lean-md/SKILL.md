...
when_to_use: Reach for this on a working CLAUDE.md that has accumulated cruft over many sessions, or before sharing a project's CLAUDE.md as a template. Do NOT use to *structurally* reorganize CLAUDE.md (move sections, add headings) — that's `/md-structure`; this skill cuts content, not architecture.
